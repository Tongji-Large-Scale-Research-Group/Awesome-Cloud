...
| 前沿论文-计算 | [快手生成式推荐 OneRec: Unifying Retrieve and Rank with Generative Recommender and Iterative Preference Alignment](https://arxiv.org/abs/2502.18965) | 介绍生成式推荐背景，原理，优势。| [第29期](./docs/issue-29.md) |
...
| 求职信息 | 计算机硕士就业情况 | 对整体的计算机硕士就业形势进行分析，给出一些建议。 | [第26期](./docs/issue-26.md) |
