...
| 前沿论文 | [云原生数据库综述 Cloud-Native Databases: A Survey (EuroSys (CCF-A) 2025)](https://arxiv.org/pdf/2503.07437v1) | 介绍在基于云环境的集群配置问题，从最优化成本的角度出发 | [第9期](./docs/issue-9.md) |
| 前沿论文 | [Eva: Cost-Efficient Cloud-Based Cluster Scheduling (发表于 TKDE'24)](https://ieeexplore.ieee.org/document/10574374) | 从云原生数据库的演进讲起，进一步细致分类并分析每类云原生数据库的特点与问题，最终讨论可能的未来研究方向。 | [第1期](./docs/issue-1.md) |
